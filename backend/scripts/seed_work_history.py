...
ENTRIES = [
    {
        ...
        "sort_order": 0,
        "bullets": [
            "Architected Microsoft Fabric + DAX semantic models, achieving 3x query performance improvement and reducing support tickets by 40%",
            ...
            "Built AI automation agents (Python + Git/Azure DevOps OData APIs) eliminating 15+ hrs/sprint of manual engineering work",
